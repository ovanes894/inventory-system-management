...
def category_form(window):
    ...
    logo = PhotoImage(file='products (64).png')
    ...
    id_entry = Entry(details_frame, font=('times new roman', 14, 'bold'), bg='lightblue')
    ...
    category_name_entry = Entry(details_frame, font=('times new roman', 14, 'bold'), bg='lightblue')
    ...
    add_button = Button(button_frame, text='ADD', font=('times new roman', 14), width=8, cursor='hand2',
                        fg='white', bg='navyblue', command=lambda :add_category(id_entry.get(), category_name_entry.get(), description_text.get(1.0, END).strip(), treeview))

    add_button.grid(row=0, column=0, padx=20)

    delete_button = Button(button_frame, text='DELETE', font=('times new roman', 14), width=8, cursor='hand2',
                        fg='white', bg='navyblue', command = lambda :delete_category(id_entry.get(), treeview))

    delete_button.grid(row=0, column=1, padx=20)

    clear_button = Button(button_frame, text='CLEAR', font=('times new roman', 14), width=8, cursor='hand2',
                        fg='white', bg='navyblue', command= lambda :clear(id_entry, category_name_entry, description_text))
